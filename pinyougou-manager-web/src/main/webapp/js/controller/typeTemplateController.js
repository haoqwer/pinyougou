	...
	$scope.findOne=function(id){				
		typeTemplateService.findOne(id).success(
			function(response){
                ...
                $scope.entity.brandIds= JSON.parse($scope.entity.brandIds);//转换   品牌列表
				// alert(JSON.parse($scope.entity.brandIds));
                $scope.entity.specIds= JSON.parse($scope.entity.specIds);//转换规 格列表
				// alert(JSON.parse($scope.entity.specIds));
